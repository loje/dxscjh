...
(function(t, e) {
    ...
    function re(e, n, r) {
        ...
        function s(n) {
            ...
            u = B.start.getMonth(),
            d = f(new Date);
            for (s += "<table class='fc-border-separate' style='width:100%;height:100%' cellspacing='0'><thead><tr>", De && (s += "<th class='fc-week-number " + c + "'/>"), r = 0; re > r; r++) s += "<th class='fc-day-header fc-" + Se[r] + " " + c + "'/>";
    ...
    var ye = {
        ...
        dayNamesShort: ['SUN', 'MON', 'TUR', 'WEB', 'FOU', 'FRI', 'SAT'],
        buttonText: {
